...
func (mc *MembershipCreate) SetMemberID(id uuid.UUID) *MembershipCreate {
	mc.mutation.SetMemberID(id)
	return mc
}

// SetNillableMemberID sets the "member" edge to the User entity by ID if the given value is not nil.
func (mc *MembershipCreate) SetNillableMemberID(id *uuid.UUID) *MembershipCreate {
	if id != nil {
		mc = mc.SetMemberID(*id)
	}
	return mc
}

// SetMember sets the "member" edge to the User entity.
func (mc *MembershipCreate) SetMember(u *User) *MembershipCreate {
	return mc.SetMemberID(u.ID)
}

// SetOrgID sets the "org" edge to the Org entity by ID.
func (mc *MembershipCreate) SetOrgID(id uuid.UUID) *MembershipCreate {
	mc.mutation.SetOrgID(id)
	return mc
}

// SetNillableOrgID sets the "org" edge to the Org entity by ID if the given value is not nil.
func (mc *MembershipCreate) SetNillableOrgID(id *uuid.UUID) *MembershipCreate {
	if id != nil {
		mc = mc.SetOrgID(*id)
	}
	return mc
...
func (mc *MembershipCreate) SetOrg(o *Org) *MembershipCreate {
...
func (mc *MembershipCreate) createSpec() (*Membership, *sqlgraph.CreateSpec) {
	...
	if nodes := mc.mutation.MemberIDs(); len(nodes) > 0 {
		...
		_node.membership_member = &nodes[0]
